...
class DownloaderTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.dldr = downloader.Downloader(thread_count=2, crawl_interval=2, crawl_timeout=10.0, item_handler=self.handler)
    ...
    def test_wait_in_line(self):
        for i in xrange(10):
            threading.Thread(target=lambda: self.dldr._wait_in_line()).start()
